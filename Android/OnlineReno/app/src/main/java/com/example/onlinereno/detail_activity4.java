...
public class detail_activity4 extends AppCompatActivity {
    ...
    private final String fruitName = "Orange"; // Fixed fruit name
    private final double pricePerKg = 7.0; // Fixed price per kg
    private SharedPreferences sharedPreferences;
    private static final String PREFS_NAME = "StockPrefs";
    private static final String STOCK_KEY = "stock_orange";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(v -> {
            ...
            Intent checkoutIntent = new Intent(detail_activity4.this, CheckoutActivity.class);
