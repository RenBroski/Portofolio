...
public class detail_activity3 extends AppCompatActivity {
    ...
    private final String fruitName = "Watermelon"; // Fixed fruit name
    private final double pricePerKg = 4.0; // Fixed price per kg
    private SharedPreferences sharedPreferences;
    private static final String PREFS_NAME = "StockPrefs";
    private static final String STOCK_KEY = "stock_watermelon";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(v -> {
            ...
            Intent checkoutIntent = new Intent(detail_activity3.this, CheckoutActivity.class);
